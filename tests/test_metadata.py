...
class TestMetadataParity(unittest.TestCase):
    ...
    def test_readme_badges_and_test_count(self):
        # Assert test badges show 156 passed
        self.assertIn("tests-156%20passed-brightgreen.svg", self.readme_en)
        self.assertIn("tests-156%20passed-brightgreen.svg", self.readme_de)
    ...
    def test_llms_txt_consistency(self):
        ...
        self.assertIn("156 passing tests", self.llms_txt)
